...
class jts_employees(models.Model):
	...
	managerId = models.ForeignKey('self',related_name = 'manager',on_delete = models.CASCADE)
	reportingHr = models.ForeignKey('self',related_name = 'reporting_hr',on_delete = models.CASCADE)
