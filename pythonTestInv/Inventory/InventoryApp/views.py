...
def add_employee(request):
	if(request.method == "POST"):
		...
		try:
			user_input = jts_employees(fullName = fullname,userName = username,emailId = emailid,password = password,gender = gender,bloodGroup = bloodgroup,dateOfBirth = dateofbirth,dateOfJoining = dateofjoining,departmentId = department,reportingHead = reportinghead,reportingHr = reportinghr,jobRole = jobrole,Address = address,workLocation = worklocation,statusId_id = statusid)
			user_input.save()
